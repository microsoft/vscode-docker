...
Check out this [tutorial](https://code.visualstudio.com/docs/azure/docker) to utilize the other features of the extension, like linting in your docker compose file.
