...
import { DockerV2TagTreeItem } from "../dockerV2/DockerV2TagTreeItem";
import { ICachedRegistryProvider } from "../ICachedRegistryProvider";
import { IRegistryProviderTreeItem } from "../IRegistryProviderTreeItem";
import { RemoteRepositoryTreeItemBase } from "../RemoteRepositoryTreeItemBase";

export class CloudsmithRepositoryTreeItem extends RemoteRepositoryTreeItemBase implements IRegistryProviderTreeItem {
    ...
    private async getTagTime(tag: string): Promise<string> {
        ...
        let manifestResponse = await registryRequest<IManifest>(this, 'GET', manifestUrl, options);
