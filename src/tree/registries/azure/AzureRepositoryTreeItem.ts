...
export class AzureRepositoryTreeItem extends DockerV2RepositoryTreeItem {
    ...
    public constructor(parent: AzureRegistryTreeItem, repoName: string, cachedProvider: ICachedRegistryProvider, authContext?: IOAuthContext) {
        super(parent, repoName, cachedProvider, authContext);
    }
