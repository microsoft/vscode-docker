...
export class CatCodiconsPanel {
    ...
    public static show(extensionUri: vscode.Uri, results: string) {
    ...
    private static _getHtmlForWebview(webview: vscode.Webview, extensionUri: vscode.Uri, results: string) {
        console.log(results);
        // Get resource paths
