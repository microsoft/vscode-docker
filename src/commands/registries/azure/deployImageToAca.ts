...
// import { contextValueExperience, IActionContext, UserCancelledError } from '@microsoft/vscode-azext-utils';
...
// export async function deployImageToAca(context: IActionContext, node?: UnifiedRegistryItem<unknown>): Promise<void> {
